...
try {
  ...
  const requiredKeys = ["quantity_3_details", "quantity_6_details", "quantity_9_details"];
  const metafieldMap = {};
  ...
  const result = variants.map(variant => {
    ...
    return {
      ...
      metafieldKey,
      metafieldItems: metafieldKey && metafieldMap[metafieldKey] ? metafieldMap[metafieldKey] : []
    };
  });
